...
@Service
public class CommerceOutboxService {

    private static final Logger log = LoggerFactory.getLogger(CommerceOutboxService.class);

    private final JdbcTemplate jdbc;
    private final ObjectMapper objectMapper;

    public CommerceOutboxService(JdbcTemplate jdbc, ObjectMapper objectMapper) {
        this.jdbc = jdbc;
    ...
    public void publishEvent(String type, String propertyId, Map<String, Object> payload) {
        ...
        try {
            ...
            log.info("Outbox: queued commerce domain event {} ({})", type, eventId);
        } catch (Exception e) {
