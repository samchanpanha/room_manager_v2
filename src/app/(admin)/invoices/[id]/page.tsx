      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardContent className="p-5">
            ...
            <p className="mt-2 text-right text-xs text-muted-foreground">total = Σ items − discount + tax · enforced in engine, service and CI</p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-4">
              ...
              <dl className="space-y-2 text-sm">
                ...
                {invoice.voidReason ? (
                  <div className="border-t pt-2">
                    <dt className="text-destructive">Voided</dt>
          ...
          {invoice.creditNotes.length > 0 ? (
            <Card>
              <CardContent className="p-5">
                <p className="mb-3 text-sm font-medium">Credit notes</p>
