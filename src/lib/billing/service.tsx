  ...
  const buffer = await renderToBuffer(
    <InvoicePdf
      data={{
        ...
        orgLegalName: orgSettings.legalName || undefined,
        ...
        orgTaxId: orgSettings.taxId || undefined,
        orgLogo: orgSettings.logo || undefined,
        invoiceFooterNote: orgSettings.invoiceFooterNote || undefined,
        invoiceTemplate: orgSettings.invoiceTemplate || "classic",
