...
export const MODULE_GUIDE: ModuleGuideEntry[] = [
  ...
  { key: "M07", name: "Invoices", purpose: "Billing documents for periodic rent, utilities, add-ons, and security deposits.", tips: ["Monthly generation jobs bill all active leases gapless (PROP-YEAR-SEQ).", "Security deposits ride the invoice pipeline as isDeposit=true documents due at move-in.", "Issued invoices are immutable: corrections use credit notes; voids require Super Admin + reason."] },
  ...
  { key: "M09", name: "Payments", purpose: "Collect money against invoices with receipt allocation and ledger postings.", tips: ["Status moves pending → confirmed upon physical drawer or bank verification.", "Allocations target invoices oldest-first by default, or specific selected invoices.", "Unallocated amounts become member credit; confirmation auto-allocates receipt numbers (RCP-xxxx)."] },
  { key: "M10", name: "Deposits", purpose: "Security deposit lifecycle: billed via invoice, held in liability (2100), and settled at move-out.", tips: ["Lease activation auto-issues a deposit installment invoice.", "Paying the deposit invoice moves status from 'billed' to 'held' in 2100 Deposit Liability.", "Move-out settlement requires a completed move-out inspection, evidence-backed deductions, and remainder refund."] },
