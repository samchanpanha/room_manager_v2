...
export const DOC_ENTITIES = ["MEMBER", "LEASE", "ROOM", "OWNER", "CONTRACT", "INVOICE", "PAYMENT", "INSPECTION", "SALE", "EXPENSE", "STATEMENT", "STOCK_ITEM", "POS_PRODUCT", "SERVICE_CATALOG"] as const;
