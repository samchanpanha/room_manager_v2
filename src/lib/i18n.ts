...
const en: Record<string, string> = {
  ...
  "nav.item.My Account": "My Account",
  "nav.item.Help & Guide": "User Guide",
  "nav.item.Admin Guide": "Admin Guide",
  "nav.item.Tenant Portal": "Tenant Portal",
  "nav.item.Telegram Bot": "Telegram Bot",
  "nav.item.Reports": "Reports",
  "nav.item.Organizations": "Organizations",
...
const km: Record<string, string> = {
  ...
  "nav.item.My Account": "គណនីរបស់ខ្ញុំ",
  "nav.item.Help & Guide": "ជំនួយ និងការណែនាំ",
  "nav.item.Admin Guide": "មគ្គុទ្ទេសក៍អ្នកគ្រប់គ្រង",
  "nav.item.Tenant Portal": "ខ្លោងទ្វារអ្នកជួល",
  "nav.item.Telegram Bot": "តេលេក្រាមបូត",
  "nav.item.Reports": "របាយការណ៍",
  "nav.item.Organizations": "អង្គភាព/ក្រុមហ៊ុន",
...
const zh: Record<string, string> = {
  ...
  "nav.item.My Account": "我的账户",
  "nav.item.Help & Guide": "帮助与指南",
  "nav.item.Admin Guide": "管理员指南",
  "nav.item.Tenant Portal": "租客门户",
  "nav.item.Telegram Bot": "Telegram 机器人",
  "nav.item.Reports": "报表",
  "nav.item.Organizations": "组织机构",
  "nav.item.Users": "用户",
