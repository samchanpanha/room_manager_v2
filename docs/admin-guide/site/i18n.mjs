// Admin-guide site i18n — aggregates the per-language content used by build.mjs.
//
// Three languages, mirroring the app's switchable UI (src/lib/i18n.ts):
//   en  — English  (source of truth; part text lives in docs/admin-guide/*.md)
//   km  — Khmer    (part text: docs/admin-guide/km/*.md)
//   zh  — Chinese  (part text: docs/admin-guide/zh/*.md)
//
...
//   WALKS       walkthroughs — same ids & step counts across languages
